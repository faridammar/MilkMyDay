...
<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <!-- Page level plugins -->
    <script src="cssadmin/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="cssadmin/js/demo/chart-area-demo.js"></script>
    <script src="cssadmin/js/demo/chart-pie-demo.js"></script>
