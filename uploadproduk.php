                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Silahkan Unggah Produk !</h1>
                            </div>
                            <form method="post" action="uploadaksi.php" class="user" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <input type="file" class=" form-control-user" id="foto"
                                        placeholder="Unggah Foto Produk" accept="image/*" required name="foto">
                                </div>
